...
const Input = (props) => {
    ...
    return(
        <Form.Group controlId={`formBasic${props.data.label}`}>
            ...
            {
                props.data.value ?
                <Form.Control name={props.data.name} onChange={toggle} value={check} type={props.data.type} placeholder={`Enter your ${props.data.label}`} required isInvalid={props.errors[props.data.name]} />
                :
                <Form.Control name={props.data.name} onChange={toggle} type={props.data.type} placeholder={`Enter your ${props.data.label}`} required isInvalid={props.errors[props.data.name]} />
            }
